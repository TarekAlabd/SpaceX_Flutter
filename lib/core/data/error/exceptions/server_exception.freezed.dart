...
class _$ServerExceptionTearOff {
  ...
  InternalError internalError({required String message}) {
    return InternalError(
      message: message,
    );
  }

  ServiceUnavailable serviceUnavailable({required String message}) {
...
/// @nodoc
class _$UnknownCopyWithImpl<$Res> extends _$ServerExceptionCopyWithImpl<$Res>
...
abstract class InternalError implements ServerException {
  const factory InternalError({required String message}) = _$InternalError;
...
abstract class ServiceUnavailable implements ServerException {
  const factory ServiceUnavailable({required String message}) =
